...
// integration
func cumtrapz(_ x:ndarray)->ndarray{
...
func ifft(_ yr: ndarray, yi: ndarray) -> ndarray{
    let N = yr.n
    var x = zeros(N)
...
func fftconvolve(_ x:ndarray, kernel:ndarray)->ndarray{
