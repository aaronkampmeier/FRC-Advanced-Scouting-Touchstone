...
class SVM {
    ...
    func train(_ responses: matrix, _ targets: ndarray){
    ...
    func predict(_ response: ndarray) -> Double{
    ...
    func predict(_ responses: matrix) -> ndarray{
...
class kNearestNeighbors{
    ...
    func train(_ responses: matrix, targets: ndarray){
        self.M = responses.shape.0
        self.N = responses.shape.1
    ...
    func predict(_ x: ndarray, k: Int) -> Double{
